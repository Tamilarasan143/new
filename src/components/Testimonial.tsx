...
import img1 from "../assets/images/spa/spa1.jpeg";
 
export default function Testimonial() {
  return (
    <div className="container-xxl py-5">
      <div className="container">
        <div className="text-center mx-auto mb-5 wow fadeInUp service-wd" data-wow-delay="0.1s">
        ...
        <div className="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
          <div className="testimonial-item bg-light rounded p-4">
            <div className="d-flex align-items-center mb-4">
              <img className="flex-shrink-0 rounded-circle border p-1" src={img1} alt="" />
                <div className="ms-4">
