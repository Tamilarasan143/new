      ...
      <div className="container marketing">
        ...
        <div className="row mt-5" >
          <div className="col-lg-4">
            ...
            <p><Link className="btn btn-secondary" to={'details/spa'} >View details &raquo;</Link></p>
          </div>
          <div className="col-lg-4">
            ...
            <p><Link className="btn btn-secondary" to={'details/party'}>View details &raquo;</Link></p>
          </div>
          <div className="col-lg-4">
            ...
            <p><Link className="btn btn-secondary"  to={'details/bar'}>View details &raquo;</Link></p>
          </div>
        </div>
        ...
        <div className="row featurette">
          <div className="col-md-7">
            <h2 className="featurette-heading">Turn off your mind, relax, and float downstream <span className="text-muted">It’ll blow your mind.</span></h2>
